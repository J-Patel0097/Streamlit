...
st.markdown("[Streamlit cheatsheet](http://cheat-sheet.streamlit.app/)")
st.success("Success")
st.info("Information")
...
st.video("https://www.youtube.com/watch?v=6xdRuJoEMoU")
...
if st.button("Play2"):
    st.text("Enjoy Music")
    st.video("https://www.youtube.com/watch?v=ac3t0IsvokU&list=RDCLAK5uy_ksEjgm3H_7zOJ_RHzRjN1wY-_FFcs7aAU")
